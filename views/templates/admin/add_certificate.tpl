...
<form action="{$form_action|escape:'html':'UTF-8'}" method="post" class="form-horizontal">
	<div class="panel">
	    <div class="panel-heading">{l s='Add Trusted Shops certificate' mod='trustedshops'}</div>
	<div class="form-wrapper">
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='New certificate' mod='trustedshops'}</label>
	<div class="col-lg-4">
