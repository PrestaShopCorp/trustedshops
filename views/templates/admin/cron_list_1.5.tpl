...
*}
<fieldset>
    <legend><img src="../img/admin/warning.gif" alt="" /> {l s='Cronjob configuration' mod='trustedshops'}</legend>
    <p>
	...
	<div class="hint" style="display: block;">{$cron_path|escape:'html':'UTF-8'}</div>
    </p>
    <p>
	{l s='The corresponding line in your cron file may look like this:' mod='trustedshops'}
	<div class="hint" style="display: block;">*/10 * * * * {$cron_path|escape:'html':'UTF-8'}>/dev/null 2>&1</div>
    </p>
</fieldset>